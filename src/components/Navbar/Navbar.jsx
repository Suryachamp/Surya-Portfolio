...
import './Navbar.css'
import suryaLogo from '../../media/surya-logo.svg'
  ...
  return (
    <header className={`navbar ${scrolled ? 'navbar--scrolled' : ''} ${menuOpen ? 'navbar--menu-open' : ''}`}>
      <div className="navbar-inner container">
        {/* Logo */}
        <a href="#hero" className="navbar-logo" onClick={() => handleNavClick('Home', '#hero')}>
        ...
        <div className="navbar-actions">
          ...
          <a href="https://github.com/Suryachamp" target="_blank" rel="noreferrer" className="navbar-icon-btn" aria-label="GitHub">
          ...
          <a href="https://linkedin.com/in/surya-sekhar-prajapati-632708262/" target="_blank" rel="noreferrer" className="navbar-icon-btn" aria-label="LinkedIn">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
      ...
      {/* Mobile Dropdown */}
      <nav className={`navbar-mobile-menu ${menuOpen ? 'navbar-mobile-menu--open' : ''}`} aria-label="Mobile navigation">
        {NAV_LINKS.map(link => (
          <a
            key={link.label}
            href={link.href}
